...
public class GroupChatActivity extends BaseActivity{
    ...
    private GroupModel currentgroup;// 创建聊天用户对象
    private TextView tvfriendname;// 标题聊天对象的昵称
    private String groupname;// 聊天用户名字
    private ListView listviewdialog;// 对话框
    public final static int REFRESH = 123;// 发送消息验证码
    private ArrayList<GroupMessage> messageList = new ArrayList<>();// 创建一个信息的集合
    private String groupid;
    private int userid;// 聊天的用户qq 用户qq
    ...
    private GroupMessage message2;// 消息对象2
    private GroupMessage message3;// 消息对象3
    private GroupMessage message4;// 消息对象4
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.arg2) {
                case 22:
                    ...
                    if (!fBoolean) {
                        listviewdialog.setAdapter(new GroupChatActivity.MyChatAdapter());
                    }
                    break;
                case 23:
                    // 用冒泡排序来比较发送信息的时间进行排序
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentgroup = bundle.getParcelable("group");
        ...
        //BaseActivity.setCurrentFriend(currentgroup);
        // 给聊天的对象名字赋值
        ...
        btnsendmessage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (!TextUtils.isEmpty(etinputmessage.getText())) {
                    ...
                    // 创建一个信息对象信息
                    message2 = new GroupMessage(userid, 0, groupid, usermesssage, time, 0, 0);
                    // 发送消息
                    try {
        ...
        // 对好友设置
        imagebtnsetting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
    ...
    public void setChatMessageToView(GroupMessage msg){
        messageList.add(msg);
    ...
    class MyChatAdapter extends BaseAdapter {
        ...
        public View getView(int arg0, View arg1, ViewGroup arg2) {
            ...
            // 取出对应消息
            GroupMessage msg = messageList.get(arg0);
            // 控件上赋值
